...
// isi data log untuk ditulis di file
const logData = `
...
// Fungsi untuk menulis data log ke dalam file
fs.writeFile(logFileName, logData, (err) => {
  if (err) {
    console.error('Gagal menulis file:', err);
  } else {
    console.log('Data log berhasil ditulis ke dalam file!!', logFileName);
  }
});
